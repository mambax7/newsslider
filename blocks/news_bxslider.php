...
function b_news_bxslider_edit($options)
{
    ...
    $form .= "<option value='0' " . (($options[2] == '0') ? ' selected' : '') . '>' . _NO . "</option>\n";
    $form .= "<option value='1' " . (($options[2] == '1') ? ' selected' : '') . '>' . _LEFT . "</option>\n";
    $form .= "<option value='2' " . (($options[2] == '2') ? ' selected' : '') . '>' . _RIGHT . "</option>\n";
    $form .= "</select></td></tr>\n";
    //---
    ...
    $form .= "<option value='0' " . (($options[4] == '0') ? ' selected' : '') . '>' . _NONE . "</option>\n";
    $form .= "<option value='1' " . (($options[4] == '1') ? ' selected' : '') . '>' . _LEFT . "</option>\n";
    $form .= "<option value='2' " . (($options[4] == '2') ? ' selected' : '') . '>' . _RIGHT . "</option>\n";
    $form .= "<option value='3' " . (($options[4] == '3') ? ' selected' : '') . '>' . _MB_NWS_JUSTIFY . "</option>\n";
    $form .= "</select></td></tr>\n";
    //---
    ...
    $form .= "<option value='0' " . (($options[8] == '0') ? ' selected' : '') . '>' . _MB_NWS_HORIZONTAL . "</option>\n";
    $form .= "<option value='1' " . (($options[8] == '1') ? ' selected' : '') . '>' . _MB_NWS_VERTICAL . "</option>\n";
    $form .= "<option value='2' " . (($options[8] == '2') ? ' selected' : '') . '>' . _MB_NWS_FADE . "</option>\n";
    $form .= "<option value='3' " . (($options[8] == '3') ? ' selected' : '') . '>' . _MB_NWS_TICKER . "</option>\n";
    $form .= "</select></td></tr>\n";
    //---
    $form .= "<tr><td class='even'>" . _MB_NWS_EASING . "</td><td class='odd'>";
    $form .= "<input type='radio' name='options[9]' value='1'" . (($options[9] == 1) ? ' checked' : '') . '>' . _YES . '&nbsp;';
    $form .= "<input type='radio' name='options[9]' value='0'" . (($options[9] == 0) ? ' checked' : '') . '>' . _NO . '<br></td></tr>';
    //---
    ...
    $form .= "<input type='radio' name='options[16]' value='1'" . (($options[16] == 1) ? ' checked' : '') . '>' . _YES . '&nbsp;';
    $form .= "<input type='radio' name='options[16]' value='0'" . (($options[16] == 0) ? ' checked' : '') . '>' . _NO . '<br></td></tr>';
    //---
