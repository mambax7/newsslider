 ...
 */
function xoops_module_pre_update_newsslider(XoopsModule $module)
{
...
function xoops_module_update_newsslider(XoopsModule $module, $previousVersion = null)
{
    ...
    /** @var Newsslider\Helper $helper */
    /** @var Newsslider\Utility $utility */
    /** @var Newsslider\Configurator $configurator */
    $helper  = Newsslider\Helper::getInstance();
    $utility = new Newsslider\Utility();
    $configurator = new Newsslider\Configurator();

    if ($previousVersion < 240) {

        //rename column EXAMPLE
        $tables     = new Tables();
        $table      = 'newssliderx_categories';
        $column     = 'ordre';
        $newName    = 'order';
